...
| Galeri Foto Owner | Selesai → merged ke /galeri |
| Galeri gabung (foto studio + karya murid, lightbox penuh) | Selesai |
...
| Mini About section (homepage, teks + link) | Selesai |
| Mini Store section (homepage, teks + link) | Selesai |
| Gallery "Lihat Semua" link (homepage → /galeri) | Selesai |
| Halaman legal (Privasi, Syarat 11 section, FAQ, Kontak, Tentang) | Selesai |
| Navbar + Footer restructure (6 link baru) | Selesai |
| Hero badge "KELAS MENGGAMBAR UNTUK SEMUA UMUR" (teks polos) | Selesai |
| JSON-LD Structured Data (LocalBusiness schema) | Selesai |
| OG Tags (Open Graph metadata) | Selesai |
| Jam Operasional (Kontak page) | Selesai |
| Lokasi Negara + Wilayah (terpisah, Meta-friendly) | Selesai |
...
- **Galeri Sketsa:** dinamis dari gallery_photos, admin toggle Beranda, limit 6. Halaman /galeri punya lightbox penuh (like, share, merch, prev/next).
