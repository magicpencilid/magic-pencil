    ...
    <div className="space-y-3">
      ...
      {notifStatus === null && (
        <button
          ...
          className="w-full bg-accent text-white py-2.5 rounded-full text-sm font-semibold hover:bg-accent-dark transition-all flex items-center justify-center gap-2"
        >
